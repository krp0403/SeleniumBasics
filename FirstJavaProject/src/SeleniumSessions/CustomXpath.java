...
public class CustomXpath {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@class='sb_form_q']")).sendKeys(Keys.ENTER);
...
//		Action.sendKeys(Keys.ENTER);
		...
		*/
		...
		drive.findElement(By.xpath("//input[contains(@class,'sb_form_')]")).sendKeys("google");
		drive.findElement(By.xpath("//input[contains(@class,'sb_form_')]")).sendKeys(Keys.ENTER);
